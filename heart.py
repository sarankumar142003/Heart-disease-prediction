...
# Manual Encoding
def encode(val,map):
    return map.get(val,0)
sex_map={"MALE":1,"FEMALE":0}

# Prediction
if submit:
    sex_ec=encode(Sex,sex_map)
    input=np.array([[Age,sex_ec,Chest_pain,BP,Cholesterol,  FBS,EKG_results,Max_HR,Exercise_angina,ST_depression,Slope_of_ST,Number_of_vessels_fluro,Thallium]])
